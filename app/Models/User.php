...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'sec_q1', 'sec_q1_ans', 'sec_q2', 'sec_q2_ans', 'sec_q3', 'sec_q3_ans', 'sec_q4', 'sec_q4_ans', 'sec_q5', 'sec_q5_ans', 'status', 'product_id'
        // 'reference_code',
    ];
    ...
    public function parent() {
        return $this->hasOne(User::class,'id','parent_referral')->select('id', 'name','referral_code','cleared','role_id');
    }
